...
import type { NodeType, NonLeafNode, NonRootNode } from './types.js'
...
export class AbstractNode {
  ...
  constructor(public level: number, rootNode: RootNode | null, type: NodeType) {
    this.type = type
  ...
  applyEliminationRule<T extends AbstractNode>(
    ...
    const other = findSimilarNode(this, nodesOfSameLevel as any[])
    if (other) {
